          ...
          <div className="flex items-center space-x-3">
            ...
            {!user && (
              <a
                ...
                className="hidden md:flex items-center gap-2 px-4 py-2 bg-[#5865F2] text-white hover:bg-[#4752C4] rounded-md transition-colors whitespace-nowrap font-semibold text-sm"
              >
