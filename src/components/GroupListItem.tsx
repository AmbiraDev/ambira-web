  ...
  return (
    <div className="relative group/item">
      ...
      <Link
        ...
        className="block py-3 px-3 -mx-3 rounded-lg hover:bg-gray-50 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0066CC] focus-visible:ring-offset-2"
      >
          ...
          <div className="flex-shrink-0">
            {isJoined ? (
              ...
              <button
                ...
                disabled={isJoining}
                aria-label={
                  isJoining ? `Joining ${group.name}` : `Join ${group.name}`
                }
                className={`min-h-[44px] px-4 text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0066CC] focus-visible:ring-offset-2 rounded relative z-10 ${
                  isJoining
