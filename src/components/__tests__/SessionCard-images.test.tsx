...
describe('SessionCard - Image Display', () => {
  ...
  it('should render session without images correctly', () => {
    render(
      <SessionCard
        session={baseSession}
        onSupport={mockOnSupport}
  ...
  it('should maintain correct layout with images', () => {
    const sessionWithImages = {
      ...baseSession,
      images: ['https://example.com/image.jpg']
    };
  ...
  it('should work with all session interactions when images are present', () => {
    const sessionWithImages = {
      ...baseSession,
      images: ['https://example.com/image.jpg']
    };
  ...
  it('should render correctly when description is expanded with images', () => {
    const sessionWithImages = {
      ...baseSession,
