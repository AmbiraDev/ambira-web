...
export const StreakNotification: React.FC<StreakNotificationProps> = ({ userId, onDismiss }) => {
    ...
    <div className="fixed bottom-4 right-4 max-w-md bg-white rounded-lg shadow-lg border-2 border-orange-400 p-4 z-50 animate-slide-up">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-gray-900 mb-1">Don't break your streak!</h3>
          ...
          {streakStats.nextMilestone && (
            <p className="text-xs text-gray-500">
              Only {streakStats.nextMilestone - streakStats.currentStreak} days until your next
              milestone! 🎯
            </p>
          )}
        </div>
