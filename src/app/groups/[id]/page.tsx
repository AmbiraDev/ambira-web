...
export default async function GroupPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <ProtectedRoute>
      <ErrorBoundary
        fallback={
          <ErrorFallback groupId={params.id} />
        }
      >
...
function ErrorFallback({ groupId }: { groupId: string }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Error loading group</h2>
        <p className="text-gray-600 mb-6">Something went wrong while loading this group.</p>
        <button
