...
import { MyGroupListItem } from '@/features/groups/components/MyGroupListItem'
...
export default function GroupsPage() {
  ...
  const { suggestedGroups: fetchedSuggestedGroups, isLoading: isLoadingSuggestedGroups } =
    useSuggestedGroups({
      userId: user?.id,
      enabled: !!user?.id,
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 w-full max-w-[1400px] mx-auto pt-6 pb-4 md:py-8 min-h-[calc(100vh-3.5rem)]">
          ...
          <div className="text-center py-12 px-6 md:px-8">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Search for groups to connect with like-minded people, participate in challenges, and
                stay motivated!
              </p>
              <Link
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-6 px-6 md:px-8">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-900">Suggested Groups</h2>
            </div>
            <Link
              href="/search?type=groups"
          ...
          {isLoadingSuggestedGroups ? (
            ...
            <div className="text-center py-12 px-6 md:px-8">
              <div className="max-w-md mx-auto">
                <Users className="w-16 h-16 text-gray-300 mx-auto mb-4" aria-hidden="true" />
                <h3 className="text-xl font-semibold text-gray-900 mb-2">No groups to suggest</h3>
                <p className="text-gray-600 mb-6">
                  You've joined all available groups, or there are no public groups yet. Check back
