    ...
    <div className={staticPageStyles.containers.page}>
      <div className={staticPageStyles.containers.content}>
        ...
        <div className={`${staticPageStyles.containers.card} mb-6`}>
          ...
          >
            At Ambira, we take your privacy seriously. This Privacy Policy
            explains how we collect, use, disclose, and safeguard your
            information when you use our social productivity tracking platform.
          </p>
          <p className={staticPageStyles.typography.bodyText}>
            By using Ambira, you agree to the collection and use of information
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-4 text-center">
            <div className="bg-[#0066CC] rounded-lg p-3 w-fit mx-auto mb-3">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="flex items-center mb-4">
              <Database className="w-6 h-6 text-[#0066CC] mr-2" />
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  address, username, and password. You may optionally provide
                  additional profile information such as a profile picture and
                  bio.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  We collect information about your work sessions including
                  duration, project names, task descriptions, timestamps, and
                  any notes you add. You control the visibility of this data
              ...
              <div>
                ...
                <p className="text-gray-700">
                  We track your social activity including follows, supports
                  (likes), comments, group memberships, and challenge
                  participation to provide social features and analytics.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  We collect information about how you interact with Ambira,
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                ...
                <span>
                  Provide and maintain the Ambira platform and its features
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-[#0066CC] mr-2 mt-1">•</span>
                <span>
                  Enable social features like following, commenting, and group
                  participation
                </span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                <span className="text-[#0066CC] mr-2 mt-1">•</span>
                <span>
                  Send notifications about activity on your account (with your
                  permission)
                </span>
              </li>
              <li className="flex items-start">
            ...
            <div className="space-y-3">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-700">
                  Choose who can view your profile: Everyone, Followers Only, or
                  Private
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-700">
                  Set default visibility for work sessions: Public, Followers,
                  or Private
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  settings, other users may see your profile, sessions, and
                  activity
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-[#0066CC] mr-2 mt-1">•</span>
                <span>
                  <strong>Service Providers:</strong> We use Firebase (Google)
                  for authentication and data storage, subject to their privacy
                  policies
                </span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span>
                  ...
                  or acquisition, user data may be transferred to the new entity
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="flex items-center mb-4">
              <Lock className="w-6 h-6 text-[#0066CC] mr-2" />
              <h2 className="text-2xl font-bold text-gray-900">
                Data Security
              </h2>
            </div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start">
                <span className="text-[#0066CC] mr-2 mt-1">•</span>
                <span>
                  Secure password hashing and authentication via Firebase Auth
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-[#0066CC] mr-2 mt-1">•</span>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <p className={`${staticPageStyles.typography.bodyText} mt-4`}>
              ...
              <a
                ...
                className={staticPageStyles.links.email}
              >
                privacy@ambira.app
              </a>
            </p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <p className="text-gray-700">
              ...
              or as needed to provide services. When you delete your account, we
              will delete or anonymize your personal information within 30 days,
              except where we are required to retain it for legal compliance or
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <p className="text-gray-700">
              Ambira is not intended for users under the age of 13. We do not
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <p className="text-gray-700">
              Ambira is hosted in the United States. If you access the platform
              from outside the US, your information may be transferred to,
              stored, and processed in the US. By using Ambira, you consent to
              this transfer.
            </p>
          </div>
          ...
          <div className={staticPageStyles.gradientCta}>
            <div className="flex items-center mb-4">
              ...
              <h2
                className={`${staticPageStyles.typography.sectionHeading} text-white`}
              >
                Contact Us
              </h2>
            </div>
