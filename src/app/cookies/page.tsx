...
import { ArrowLeft, Cookie, Shield, Eye, Settings, Globe, BarChart } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center mb-4">
            <Cookie className="w-8 h-8 text-[#007AFF] mr-3" />
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
          <p className="text-gray-700 leading-relaxed mb-4">
            This Cookie Policy explains how Ambira uses cookies and similar technologies to recognize you when you
            visit our platform. It explains what these technologies are, why we use them, and your rights to control
            their use.
          </p>
          <p className="text-gray-700 leading-relaxed">
            By using Ambira, you consent to the use of cookies in accordance with this policy.
          </p>
        </div>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="flex items-center mb-4">
              <div className="bg-[#007AFF] rounded-lg p-3 mr-3">
                <Shield className="w-6 h-6 text-white" />
              </div>
              <h2 className="text-2xl font-bold text-gray-900">Essential Cookies</h2>
            </div>
            <p className="text-gray-700 mb-4">
              These cookies are strictly necessary for the website to function and cannot be disabled. They enable
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="text-left py-2 text-sm font-semibold text-gray-900">Cookie Name</th>
                    <th className="text-left py-2 text-sm font-semibold text-gray-900">Purpose</th>
                    <th className="text-left py-2 text-sm font-semibold text-gray-900">Duration</th>
                  </tr>
                </thead>
                <tbody className="text-sm text-gray-700">
                  <tr className="border-b border-gray-100">
                    <td className="py-3 font-mono text-xs">firebase-auth-token</td>
                    <td className="py-3">Maintains user authentication session</td>
                    <td className="py-3">Session</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 font-mono text-xs">session-state</td>
                    <td className="py-3">Preserves active timer and session state</td>
                    <td className="py-3">Persistent</td>
                  </tr>
                  <tr>
                    <td className="py-3 font-mono text-xs">csrf-token</td>
                    <td className="py-3">Security token to prevent cross-site attacks</td>
                    <td className="py-3">Session</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <table className="w-full">
                ...
                <tbody className="text-sm text-gray-700">
                  ...
                  <tr>
                    <td className="py-3 font-mono text-xs">notification-settings</td>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <p className="text-gray-700 mb-4">
              These cookies help us understand how visitors interact with Ambira by collecting and reporting
              information anonymously. This helps us improve the platform.
            </p>
            <div className="bg-gray-50 rounded-lg p-4">
              <table className="w-full">
                <thead>
                ...
                <tbody className="text-sm text-gray-700">
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-3">Google Analytics - tracks user sessions</td>
                    <td className="py-3">2 years</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 font-mono text-xs">_ga_*</td>
                    <td className="py-3">Google Analytics - maintains session state</td>
                    <td className="py-3">2 years</td>
                  </tr>
                  <tr>
                    <td className="py-3 font-mono text-xs">usage-metrics</td>
                    <td className="py-3">Tracks feature usage for improvements</td>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
          <div className="flex items-center mb-4">
            <Globe className="w-6 h-6 text-[#007AFF] mr-2" />
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-700 mb-2">
                Provides authentication, database, and analytics services. Firebase may set cookies for
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-700 mb-2">
                Helps us understand how users interact with our platform through anonymized usage data.
              </p>
              <a
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <div>
                ...
                <span className="text-gray-700"> Most browsers allow you to refuse or accept cookies through their settings. Note that blocking essential cookies may affect site functionality.</span>
              </div>
            </div>
            <div className="flex items-start">
              <span className="text-[#007AFF] mr-2 mt-1">•</span>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <span className="text-gray-700"> You can delete cookies already stored on your device through your browser settings. This will sign you out of Ambira.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Managing Cookies by Browser</h2>
          <p className="text-gray-700 mb-4">
        ...
        <div className="bg-gradient-to-r from-[#007AFF] to-[#0051D5] text-white rounded-lg p-8">
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <Button asChild variant="outline" className="bg-white text-[#007AFF] hover:bg-gray-100">
