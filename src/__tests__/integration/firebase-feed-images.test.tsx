...
describe('Firebase Feed Images Integration', () => {
  ...
  describe('Loading images from Firestore', () => {
    ...
    it('should handle sessions with undefined images field', async () => {
  ...
  describe('Filtering sessions by image presence', () => {
    it('should load both sessions with and without images', async () => {
      const mockSessions = [
        {
          id: 's1',
          userId: 'u1',
  ...
  describe('Image URL validation in Firestore data', () => {
    it('should only accept valid Firebase Storage URLs', async () => {
      const mockSession = {
        id: 'session1',
        userId: 'user1',
        title: 'Session',
    ...
    it('should handle maximum 3 images per session', async () => {
      const mockSession = {
        id: 'session1',
        userId: 'user1',
  ...
  describe('populateSessionsWithDetails with images', () => {
    it('should populate images field when loading session details', async () => {
  ...
  describe('Feed performance with images', () => {
    it('should load multiple sessions with images efficiently', async () => {
