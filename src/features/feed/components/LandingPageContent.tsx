    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            href="/auth"
            className="inline-block px-8 py-4 bg-[#007AFF] text-white font-semibold rounded-lg hover:bg-[#0051D5] transition-colors text-lg shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none min-h-[44px]"
          >
            Sign Up Free
          </Link>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 space-y-16 md:space-y-32">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          <div className="flex-1 space-y-4 md:pt-12 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-600">
              Track your study and work sessions, then share them with friends.
              Get encouragement and support as you make progress on your goals.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          <div className="flex-1 space-y-4 md:pt-12 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-600">
              See detailed insights into your productivity patterns. Track your
              progress over time and discover when you work best.
            </p>
          </div>
          <div className="flex-1">
            <div className="rounded-xl overflow-hidden border border-gray-200 shadow-md">
      ...
      <section className="max-w-6xl mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#5865F2] text-white font-semibold rounded-lg hover:bg-[#4752C4] transition-colors text-lg shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] focus-visible:ring-offset-2 min-h-[44px]"
          >
            <svg
              width="24"
              height="24"
