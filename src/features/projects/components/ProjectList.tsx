      ...
      {filteredProjects.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-8 md:p-12">
          <div className="max-w-md mx-auto text-center">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">No activities yet</h3>
            <p className="text-sm md:text-base text-gray-600 mb-6">
              Activities help you organize your work sessions and track progress over time. Create
              your first activity to get started!
            </p>
            <button
              onClick={() => router.push('/settings/activities')}
