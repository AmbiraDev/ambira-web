...
export const firebaseChallengeApi = {
  ...
  createChallenge: async (data: CreateChallengeData): Promise<Challenge> => {
    try {
      ...
      const apiError = handleError(_error, 'Create challenge', {
  ...
  getChallenge: async (challengeId: string): Promise<Challenge> => {
    try {
      ...
      const apiError = handleError(_error, 'Get challenge', {
  ...
  getChallenges: async (filters: ChallengeFilters = {}): Promise<Challenge[]> => {
    try {
      ...
      for (const challengeDoc of snapshot.docs) {
        ...
        if (filters.isParticipating && auth.currentUser) {
          try {
            ...
            handleError(_error, `Check participation for challenge ${challengeDoc.id}`, {
      ...
      handleError(_error, 'in getChallenges', {
        severity: ErrorSeverity.ERROR,
      })
      const apiError = handleError(_error, 'Get challenges', {
        defaultMessage: ERROR_MESSAGES.CHALLENGE_LOAD_FAILED,
      })
      throw new Error(apiError.userMessage)
    }
  ...
  joinChallenge: async (challengeId: string): Promise<void> => {
    try {
      ...
      const apiError = handleError(_error, 'Join challenge', {
  ...
  leaveChallenge: async (challengeId: string): Promise<void> => {
    try {
      ...
      const apiError = handleError(_error, 'Leave challenge', {
    ...
    try {
      ...
      for (const participantDoc of participantsSnapshot.docs) {
        ...
        try {
          ...
          handleError(_error, `Load user data for participant ${participantData.userId}`, {
            severity: ErrorSeverity.WARNING,
          })
        }
      }
      ...
      const apiError = handleError(_error, 'Get challenge leaderboard', {
        defaultMessage: ERROR_MESSAGES.CHALLENGE_LOAD_FAILED,
      })
      throw new Error(apiError.userMessage)
    }
  ...
  getChallengeProgress: async (
    ...
    try {
      ...
      const apiError = handleError(_error, 'Get challenge progress', {
        defaultMessage: ERROR_MESSAGES.CHALLENGE_LOAD_FAILED,
      })
      throw new Error(apiError.userMessage)
    }
  ...
  updateChallengeProgress: async (userId: string, sessionData: Session): Promise<void> => {
    try {
  ...
  getChallengeStats: async (challengeId: string): Promise<ChallengeStats> => {
    try {
      ...
      const apiError = handleError(_error, 'Get challenge stats', {
  ...
  updateChallenge: async (challengeId: string, data: UpdateChallengeData): Promise<Challenge> => {
    try {
      ...
      const apiError = handleError(_error, 'Update challenge', {
  ...
  deleteChallenge: async (challengeId: string): Promise<void> => {
    try {
      ...
      const apiError = handleError(_error, 'Delete challenge', {
  ...
  searchChallenges: async (
    ...
    try {
      ...
      handleError(_error, 'in searchChallenges', {
        severity: ErrorSeverity.ERROR,
      })
      const apiError = handleError(_error, 'Search challenges', {
    ...
    try {
      ...
      for (const participantDoc of participantsSnapshot.docs) {
        ...
        try {
          ...
          handleError(_error, `Load challenge ${challengeId}`, {
            severity: ErrorSeverity.WARNING,
          })
        }
      }
      ...
      const apiError = handleError(_error, 'Get user challenges', {
