 ...
 */
export const convertTimestamp = (timestamp: Timestamp | Date | string | number | unknown): Date => {
 ...
 */
export const removeUndefinedFields = <T extends Record<string, unknown>>(input: T): Partial<T> => {
