...
export const CACHE_KEYS = {
  ...
  SESSIONS_FEED: (filters?: CacheFilters) => ['sessions', 'feed', filters],
  ...
  // Feed data
  FEED_SESSIONS: (limit?: number, cursor?: string, filters?: CacheFilters) => [
    'feed',
    'sessions',
    limit,
    cursor,
