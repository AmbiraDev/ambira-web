...
export function ProfileUpdateExample({ initialData }: ProfileUpdateExampleProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const hasSocialLinks =
      formData.socialLinks.twitter || formData.socialLinks.github || formData.socialLinks.linkedin
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">{formData.bio.length}/500 characters</p>
        </div>
