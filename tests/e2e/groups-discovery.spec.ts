...
test.describe('Groups Discovery Page', () => {
  ...
  test('should have accessible group cards with proper ARIA labels', async ({
    page,
  }) => {
    await page.goto('/groups');
    await page.waitForLoadState('networkidle');
  ...
  test('should maintain proper color contrast for accessibility', async ({
    page,
  }) => {
    await page.goto('/groups');
    await page.waitForLoadState('networkidle');
