...
test.describe('Settings Page', () => {
  ...
  test.describe('Navigation', () => {
    ...
    test('should switch to notifications tab when clicked', async ({
      page,
    }) => {
    ...
    test('should switch to display preferences tab when clicked', async ({
      page,
    }) => {
    ...
    test('should maintain tab selection during interactions', async ({
      page,
    }) => {
      const privacyTab = page.getByText('Privacy Controls').first();
      await privacyTab.click();
      ...
      const tabButton = page
        .locator('button')
        .filter({ hasText: 'Privacy Controls' })
        .first();
  ...
  test.describe('Profile Picture Upload', () => {
    test('should display profile picture section', async ({ page }) => {
      const uploadLabel = page
        ...
        .or(page.getByText('Profile Picture'));
    ...
    test('should show upload button', async ({ page }) => {
      const uploadButton = page
        .getByRole('button')
        .or(page.getByLabel(/Upload Photo/i));
  ...
  test.describe('Notification Settings', () => {
    test('should navigate to notification settings', async ({ page }) => {
      ...
      await expect(
        page.getByText('Choose how you want to be notified')
      ).toBeVisible();
    });
