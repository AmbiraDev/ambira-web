...
test.describe('Notifications Page - Desktop', () => {
  ...
  test.describe('Page Layout', () => {
    test('should display notifications page header on desktop', async ({ page }) => {
  ...
  test.describe('Mark All Read Button - Desktop', () => {
    test('should show Mark All Read button when there are unread notifications', async ({
      ...
      if (unreadText) {
        const markAllReadButton = page.getByTestId('mark-all-read-button-desktop')
    ...
    test('should mark all notifications as read when clicked', async ({ page }) => {
      const markAllReadButton = page.getByTestId('mark-all-read-button-desktop')
    ...
    test('should disable Mark All Read button while processing', async ({ page }) => {
      const markAllReadButton = page.getByTestId('mark-all-read-button-desktop')
  ...
  test.describe('Clear All Button - Desktop', () => {
    ...
    test('should not show Clear All button when there are no notifications', async ({ page }) => {
    ...
    test('should clear all notifications when clicked', async ({ page }) => {
      ...
      if (await clearAllButton.isVisible()) {
        ...
        const notificationsBefore = await page.locator('.divide-y.divide-gray-200 > div').count()
        ...
        const notificationsAfter = await page.locator('.divide-y.divide-gray-200 > div').count()
        expect(notificationsAfter).toBe(0)
      }
    })

    test('should disable Clear All button while processing', async ({ page }) => {
      const clearAllButton = page.getByTestId('clear-all-button-desktop')
...
test.describe('Notifications Page - Mobile', () => {
  ...
  test.describe('Page Layout', () => {
    ...
    test('should display action buttons bar on mobile', async ({ page }) => {
      ...
      if (count > 0) {
        ...
        const actionBar = page.locator('.md\\:hidden.bg-gray-50.border-b.border-gray-200')
  ...
  test.describe('Mobile Button Interaction', () => {
    ...
    test('buttons should be horizontally aligned', async ({ page }) => {
      ...
      if ((await markAllReadButton.isVisible()) && (await clearAllButton.isVisible())) {
        ...
        expect(Math.abs((markAllBox?.y || 0) - (clearAllBox?.y || 0))).toBeLessThan(5)
      }
    })

    test('action bar should be sticky at top of mobile view', async ({ page }) => {
      const actionBar = page.locator('.md\\:hidden.bg-gray-50.border-b.border-gray-200')
  ...
  test.describe('Swipe Actions on Mobile', () => {
    test('should be able to swipe notification to delete', async ({ page }) => {
      ...
      const firstNotification = page.locator('.border-b.border-gray-200').first()
...
test.describe('Notifications Page - Responsive Behavior', () => {
  test('should show desktop buttons when viewport is wide', async ({ page }) => {
  ...
  test('should show mobile buttons when viewport is narrow', async ({ page }) => {
  ...
  test('should transition between mobile and desktop layouts', async ({ page }) => {
    // Start mobile
    await page.setViewportSize({ width: 375, height: 667 })
    await page.goto('/notifications')
    await waitForNetworkIdle(page)
...
test.describe('Accessibility', () => {
  ...
  test('Mark All Read button should be keyboard accessible', async ({ page }) => {
