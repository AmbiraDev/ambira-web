...
import { Project, ProjectStats, CreateProjectData, UpdateProjectData } from '@/types'
...
describe('ProjectService', () => {
  ...
  describe('getProjects', () => {
    it('should get all projects for user', async () => {
      // ARRANGE
      const mockProjects = [mockProject, { ...mockProject, id: 'project-2', name: 'Exercise' }]
      ;(firebaseApi.project.getProjects as jest.Mock).mockResolvedValue(mockProjects)
    ...
    it('should return empty array on error', async () => {
      // ARRANGE
      ;(firebaseApi.project.getProjects as jest.Mock).mockRejectedValue(new Error('API Error'))
  ...
  describe('getProject', () => {
    it('should get single project by ID', async () => {
      // ARRANGE
      ;(firebaseApi.project.getProjectById as jest.Mock).mockResolvedValue(mockProject)
      ...
      expect(firebaseApi.project.getProjectById).toHaveBeenCalledWith('project-1')
    })
    ...
    it('should handle API errors gracefully', async () => {
      // ARRANGE
      ;(firebaseApi.project.getProjectById as jest.Mock).mockRejectedValue(new Error('API Error'))
  ...
  describe('getProjectStats', () => {
    it('should get project statistics', async () => {
      // ARRANGE
      ;(firebaseApi.project.getProjectStats as jest.Mock).mockResolvedValue(mockProjectStats)
    ...
    it('should return null if stats not found', async () => {
      // ARRANGE
      ;(firebaseApi.project.getProjectStats as jest.Mock).mockResolvedValue(null)
    ...
    it('should handle API errors gracefully', async () => {
      // ARRANGE
      ;(firebaseApi.project.getProjectStats as jest.Mock).mockRejectedValue(new Error('API Error'))
  ...
  describe('createProject', () => {
    it('should create project with valid data', async () => {
      ...
      ;(firebaseApi.project.createProject as jest.Mock).mockResolvedValue(newProject)
    ...
    it('should validate project data', async () => {
      ...
      ;(firebaseApi.project.createProject as jest.Mock).mockResolvedValue(mockProject)
    ...
    it('should propagate API errors', async () => {
      ...
      // ACT & ASSERT
      await expect(projectService.createProject({ name: 'New' })).rejects.toThrow()
    })
  })
  ...
  describe('updateProject', () => {
    it('should update project with valid data', async () => {
      ...
      ;(firebaseApi.project.updateProject as jest.Mock).mockResolvedValue(updatedProject)
      ...
      expect(firebaseApi.project.updateProject).toHaveBeenCalledWith('project-1', updateData)
    })
  ...
  describe('deleteProject', () => {
    it('should delete project by ID', async () => {
      // ARRANGE
      ;(firebaseApi.project.deleteProject as jest.Mock).mockResolvedValue(undefined)

      // ACT
      await projectService.deleteProject('project-1')

      // ASSERT
      expect(firebaseApi.project.deleteProject).toHaveBeenCalledWith('project-1')
    })
  ...
  describe('archiveProject', () => {
    it('should archive project by updating status', async () => {
      ...
      ;(firebaseApi.project.updateProject as jest.Mock).mockResolvedValue(archivedProject)
      ...
      expect(firebaseApi.project.updateProject).toHaveBeenCalledWith('project-1', {
        status: 'archived',
      })
    })
    ...
    it('should propagate errors', async () => {
      ...
      // ACT & ASSERT
      await expect(projectService.archiveProject('project-1')).rejects.toThrow('Archive failed')
    })
  })
  ...
  describe('restoreProject', () => {
    it('should restore archived project', async () => {
      ...
      ;(firebaseApi.project.updateProject as jest.Mock).mockResolvedValue(restoredProject)
    ...
    it('should propagate errors', async () => {
      ...
      // ACT & ASSERT
      await expect(projectService.restoreProject('project-1')).rejects.toThrow('Restore failed')
    })
  })
})
