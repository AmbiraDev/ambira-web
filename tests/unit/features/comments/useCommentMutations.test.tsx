...
import { CommentWithDetails, CommentsResponse, CreateCommentData } from '@/types'
...
describe('useCommentMutations', () => {
  ...
  describe('useCreateComment', () => {
    it('should optimistically add comment to cache with user data', async () => {
      ...
      const finalComments = queryClient.getQueryData<CommentsResponse>(COMMENT_KEYS.list(sessionId))
  ...
  describe('useDeleteComment', () => {
    it('should remove comment from cache', async () => {
      ...
      expect(mockFunctions.deleteComment).toHaveBeenCalledWith(commentIdToDelete)
    })
  })
