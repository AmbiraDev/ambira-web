...
import { Challenge, ChallengeLeaderboard, ChallengeProgress, ChallengeStats } from '@/types'
...
describe('ChallengeService', () => {
  ...
  describe('getChallenges', () => {
    it('should get all challenges', async () => {
      ...
      ;(firebaseApi.challenge.getChallenges as jest.Mock).mockResolvedValue(mockChallenges)
    ...
    it('should return empty array on error', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallenges as jest.Mock).mockRejectedValue(new Error('API Error'))
  ...
  describe('getChallenge', () => {
    it('should get challenge by ID', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallenge as jest.Mock).mockResolvedValue(mockChallenge)
      ...
      expect(firebaseApi.challenge.getChallenge).toHaveBeenCalledWith('challenge-1')
    })
    ...
    it('should handle API errors gracefully', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallenge as jest.Mock).mockRejectedValue(new Error('API Error'))
  ...
  describe('getChallengeLeaderboard', () => {
    it('should get challenge leaderboard', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeLeaderboard as jest.Mock).mockResolvedValue(
        mockLeaderboard
      )

      // ACT
      const result = await challengeService.getChallengeLeaderboard('challenge-1')
    ...
    it('should return null if leaderboard not found', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeLeaderboard as jest.Mock).mockResolvedValue(null)
    ...
    it('should handle API errors gracefully', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeLeaderboard as jest.Mock).mockRejectedValue(
        new Error('API Error')
      )
  ...
  describe('getChallengeProgress', () => {
    it('should get user challenge progress', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeProgress as jest.Mock).mockResolvedValue(mockProgress)

      // ACT
      const result = await challengeService.getChallengeProgress('challenge-1', 'user-1')
    ...
    it('should return null if progress not found', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeProgress as jest.Mock).mockResolvedValue(null)
    ...
    it('should handle API errors gracefully', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeProgress as jest.Mock).mockRejectedValue(
        new Error('API Error')
      )
  ...
  describe('getChallengeStats', () => {
    it('should get challenge statistics', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeStats as jest.Mock).mockResolvedValue(mockStats)
    ...
    it('should return null if stats not found', async () => {
      // ARRANGE
      ;(firebaseApi.challenge.getChallengeStats as jest.Mock).mockResolvedValue(null)
