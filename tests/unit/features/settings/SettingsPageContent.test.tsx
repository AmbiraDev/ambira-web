...
jest.mock('@/components/BottomNavigation', () => {
  const BottomNavMock: React.FC = () => <div data-testid="bottom-nav">Bottom Nav</div>
...
jest.mock('@/components/ConfirmDialog', () => {
  const ConfirmDialogMock: React.FC<{
    ...
    variant?: string
    isLoading?: boolean
  }> = ({ isOpen, onConfirm, onClose, title, message, confirmText, cancelText }) =>
    isOpen ? (
...
describe('SettingsPageContent Component', () => {
  ...
  describe('Profile Form Management', () => {
    ...
    it('maintains bio character count display', async () => {
      ...
      const bioInput = screen.getByDisplayValue('Test bio') as HTMLTextAreaElement
    ...
    it('maintains tagline character count display', async () => {
      ...
      const taglineInput = screen.getByDisplayValue('Test tagline') as HTMLInputElement
  ...
  describe('Profile Picture Upload', () => {
    it('displays current profile picture', () => {
      ...
      expect(profileImage).toHaveAttribute('src', expect.stringContaining('pic.jpg'))
    })

    it('handles successful photo upload', async () => {
      mockFirebaseUserApi.uploadProfilePicture.mockResolvedValue('https://example.com/new-pic.jpg')
  ...
  describe('Form Submission', () => {
    ...
    it('handles profile update errors', async () => {
      mockFirebaseUserApi.updateProfile.mockRejectedValue(new Error('Update failed'))
  ...
  describe('Username Display', () => {
    ...
    it('displays username as read-only field in profile form', () => {
      ...
      const usernameInputs = screen.getAllByDisplayValue('johndoe') as HTMLInputElement[]
