...
describe('lib/api/notifications', () => {
  ...
  describe('createNotification', () => {
    it('should create a notification successfully', async () => {
      ...
      const result =
        await firebaseNotificationApi.createNotification(notificationData);
  ...
  describe('getUserNotifications', () => {
    ...
    it('should limit notifications based on limitCount parameter', async () => {
      ...
      const result = await firebaseNotificationApi.getUserNotifications(
        userId,
        5
      );
    ...
    it('should return empty array if no notifications found', async () => {
      const result =
        await firebaseNotificationApi.getUserNotifications('user-nonexistent');
    ...
    it('should throw error on failure', async () => {
      ...
      await expect(
        firebaseNotificationApi.getUserNotifications('user-123')
      ).rejects.toThrow('Failed to get notifications');
    });
  });
  ...
  describe('markAsRead', () => {
    ...
    it('should throw error if notification not found', async () => {
      await expect(
        firebaseNotificationApi.markAsRead('nonexistent-id')
      ).rejects.toThrow();
    });
  });
  ...
  describe('getUnreadCount', () => {
    ...
    it('should return 0 if no notifications exist', async () => {
      const count =
        await firebaseNotificationApi.getUnreadCount('user-nonexistent');
