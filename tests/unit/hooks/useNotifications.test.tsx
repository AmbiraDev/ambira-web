...
const mockFirebaseApi = firebaseNotificationApi as jest.Mocked<typeof firebaseNotificationApi>
...
describe('hooks/useNotifications', () => {
  ...
  describe('useNotifications', () => {
    it('should fetch notifications for authenticated user', async () => {
      ...
      expect(mockFirebaseApi.getUserNotifications).toHaveBeenCalledWith('user-123', 50)
    })
    ...
    it('should respect custom limit parameter', async () => {
      ...
      await waitFor(() => {
        expect(mockFirebaseApi.getUserNotifications).toHaveBeenCalledWith('user-123', 10)
      })
    })
    ...
    it('should handle fetch errors gracefully', async () => {
      mockFirebaseApi.getUserNotifications.mockRejectedValue(new Error('Fetch failed'))
  ...
  describe('useMarkNotificationRead', () => {
    it('should mark notification as read with optimistic update', async () => {
      ...
      // Then mark as read
      const { result: mutationResult } = renderHook(() => useMarkNotificationRead(), { wrapper })
  ...
  describe('useMarkAllNotificationsRead', () => {
    it('should mark all notifications as read with optimistic update', async () => {
      ...
      const { result: mutationResult } = renderHook(() => useMarkAllNotificationsRead(), {
        wrapper,
      })
    ...
    it('should rollback on error', async () => {
      ...
      mockFirebaseApi.getUserNotifications.mockResolvedValue(mockNotifications)
      mockFirebaseApi.markAllAsRead.mockRejectedValue(new Error('Update failed'))
  ...
  describe('useDeleteNotification', () => {
    it('should delete notification with optimistic update', async () => {
      ...
      expect(mockFirebaseApi.deleteNotification).toHaveBeenCalledWith('notif-1')
    })
    ...
    it('should rollback on error', async () => {
      ...
      mockFirebaseApi.getUserNotifications.mockResolvedValue(mockNotifications)
      mockFirebaseApi.deleteNotification.mockRejectedValue(new Error('Delete failed'))
  ...
  describe('useClearAllNotifications', () => {
    it('should clear all notifications with optimistic update', async () => {
      ...
      // Then clear all
      const { result: mutationResult } = renderHook(() => useClearAllNotifications(), { wrapper })
      ...
      expect(mockFirebaseApi.clearAllNotifications).toHaveBeenCalledWith('user-123')
    })
    ...
    it('should rollback on error', async () => {
      ...
      mockFirebaseApi.getUserNotifications.mockResolvedValue(mockNotifications)
      mockFirebaseApi.clearAllNotifications.mockRejectedValue(new Error('Clear failed'))
