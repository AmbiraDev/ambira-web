...
describe('components/Sidebar', () => {
  ...
  it('renders right sidebar discovery sections', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Suggested Friends' })
    ).toBeInTheDocument();
    expect(
      screen.getByRole('button', { name: /View All Challenges/ })
    ).toBeInTheDocument();
    expect(
      screen.getByRole('button', { name: /Find and Invite Your Friends/ })
    ).toBeInTheDocument();
  });
});
