...
describe('ActivityPicker Component', () => {
  ...
  describe('Rendering', () => {
    it('should render the activity picker button', () => {
      // Arrange
      const { useAllActivityTypes } = jest.requireMock('@/hooks/useActivityTypes')
      const { useRecentActivities } = jest.requireMock('@/hooks/useActivityPreferences')
  ...
  describe('All Activities List', () => {
    ...
    it('should not display "Custom" badge for system activities', () => {
      ...
      const activities = [createMockActivityType({ id: 'work', isSystem: true })]
    ...
    it('should sort activities with recent ones first', () => {
      ...
      const allActivitiesSection = screen.getByText('All Activities').parentElement
  ...
  describe('Backward Compatibility', () => {
    it('should use legacy allActivities prop when provided', () => {
      ...
      const legacyActivities = [createMockActivity({ id: 'legacy-1', name: 'Legacy Activity' })]
